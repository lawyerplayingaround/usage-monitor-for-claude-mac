...
- **Live tray icon** with two [configurable](docs/configuration.md#tray-icon-bars) progress bars (session + weekly by default), percentage display at high usage, and theme-aware colors for light and dark taskbars
